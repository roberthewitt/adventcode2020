...
main() {
  ...
  readFileByLine("data/day7_testData.txt", processor_testData.callback, solve: () {
    print('<< test data result: ${processor_testData.pt1("shiny gold")}');
  }, onComplete: () {
    var processor_pt1 = newProcessor();
    readFileByLine("data/day7.txt", processor_pt1.callback, solve: () {
      print('<< part 1 >> result: ${processor_pt1.pt1("shiny gold")}');
    }, onComplete: () {
      var processor_pt2 = newProcessor();
      readFileByLine("data/day7.txt", processor_pt2.callback, solve: () {
